...
def build_hetero_graph(
    ...
    Args:
        ...
        K_past: Number of past timesteps to include
        lane_config: Configuration for lane extraction
        a2l_k: Number of nearest lanes to connect each agent to
        a2a_max_dist: Maximum distance for agent-to-agent edges
        full_a2a: If True, build all agent pairs; if False, only ego->others
        include_tl: If True, include traffic light nodes and edges
        include_l2l: If True, include lane-to-lane edges
    ...
    # Build A2A edges (with full_a2a parameter)
